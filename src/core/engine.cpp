...
struct Engine::Internal
{
  ...
  void run()
  {
    ...
    //GLFWwindow* window= EntityEngine::glfw::createWindow(NULL);
    window= EntityEngine::glfw::createWindow(NULL);
    if (!window)
    {
      EntityEngine::log(logTag, "Window or context creation failed");
    }
