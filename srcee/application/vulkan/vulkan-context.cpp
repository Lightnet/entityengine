...
using EntityEngine::VulkanContext;
...
struct VulkanContext::Internal
{
    ...
    {
        EntityEngine::log("EntityEngine::VulkanContext", "Initialized Vulkan context successfully.");
    }
};

VulkanContext::VulkanContext() : internal(EntityEngine::make_internal_ptr<Internal>()) {}
